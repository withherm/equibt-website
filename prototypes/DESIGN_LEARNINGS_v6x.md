...
- **Home hero soft orbit (EQT-352):** `hero-home` uses a one-shot soft-orbit settle, vertical B −2/−3px, ±5px X, ±1° rotate, 12s, one loop then rest, reduced-motion static. Motion-only, draw-on not combined in v1.
